...
| Verifier time      | < 1s                                         | < 1s                                 |
| Proof size         | 1GB on device, TODO sent to verifier         | TODO                                 |
| Implementations    |                                              |                                      |
...
- Communication protocols: TODO: we must verify if we can transport the proofs over OID4VP.
  [OID4VC spec](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0-ID1.html#name-iso-mdl) - [OID4VP spec](https://openid.net/specs/openid-4-verifiable-presentations-1_0-29.html)
...
- Communication protocols: TODO: as with Longfellow: can we transport the proofs with the OID4VP specs?
...
- Per presentation time: TODO - how much?
- Proof size: TODO: what is the size of the pre-computation part? IIRC (LiGa), it's a bit more than 1GB.
  TODO: what is the size of the proof actually being transmitted?
- Trusted Parameters: the Zero-Knowledge protocol used in Crescent (Groth16) requires the use of a "trusted set of parameters" that can be generated by either distributed protocols between holders, and verifiers (which can be difficult due to the large number of holders and verifiers) or generated by a trusted third-party.
  TODO: what is the size of these parameters?
